...
nir_tif = "E:/BrahmaKamal/Sat/script/G.TIF"  # FIXED: Use correct NIR file
output_ndvi_tif = "E:/BrahmaKamal/Sat/script/NDTI_PYTHON.TIF"
...
ndvi = (red - nir) / (nir + red + 1e-10)  # Adding a small epsilon to avoid division by zero
...
plt.title("NDTI Calculation from DJI M3M")
plt.show()
